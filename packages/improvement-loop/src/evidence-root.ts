...
/** Model / README evidence folder name for improvement series. */
export const SERIES_EVIDENCE_FOLDER = "improvement-series";

/** Model / README evidence folder name for improvement cycles. */
export const CYCLE_EVIDENCE_FOLDER = "improvement-cycles";
