...
export interface DelegationCoordinatorContext {
  ...
  /** Shell-injected clock reading for this actor (same pattern as proposal.machine). */
  transitionTime: string;
  lastTransitionTime: string;
  errorMessage?: string;
}

export interface DelegationCoordinatorInput
  extends Omit<DelegationCoordinatorContext, "lastTransitionTime" | "transitionTime"> {
  transitionTime: string;
  lastTransitionTime?: string;
}
    ...
    states: {
      open: {
        on: {
          ...
          DRAIN: {
            target: "draining",
            actions: assign({ lastTransitionTime: ({ context }) => context.transitionTime }),
          },
          ERROR: {
...
export interface DelegationRequestInput
  extends Omit<DelegationRequestContext, "lastTransitionTime" | "transitionTime"> {
  transitionTime: string;
  lastTransitionTime?: string;
}
